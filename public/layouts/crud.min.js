...
(function() {
        ...
        parse: function(response) {
            ...
            _.each(response.administrators, function(administrator) {
                outcome.push({
                    ...
                    url: "/crud/administrators/" + administrator._id + "/"
                });
            });
            return outcome;
        }
    ...
    app._SearchView = Backbone.View.extend({
        ...
        keyBuffer: function() {
            ...
            if ((new Date() - app._searchView.timeLastKeyPressed) / 1e3 >= .333) {
        ...
        render: function() {
            ...
            this.collection.each(function(record) {
                var view = new app._SearchResultView({
                    model: record
                });
