...
(function() {
  ...
  app.Delete = Backbone.Model.extend({
    ...
    url: function() {
      return '/crud/places/'+ app.mainView.model.id +'/';
    }
  });
  ...
  app.Details = Backbone.Model.extend({
    ...
    parse: function(response) {
      if (response.place) {
        app.mainView.model.set(response.place);
  ...
  app.MainView = Backbone.View.extend({
    ...
    initialize: function() {
      app.mainView = this;
      this.model = new app.Place( JSON.parse( unescape($('#data-record').html()) ) );
