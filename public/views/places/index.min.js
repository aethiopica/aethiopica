...
(function() {
    ...
    app.HeaderView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.$el.find("input[name=address]").geocomplete({
                details: "form"
            });
        },
    ...
    app.MapView = Backbone.View.extend({
        ...
        render: function() {
            ...
            if (!this.collection.length) {
                ...
                this.bounds.extend(new google.maps.LatLng(37.73, -122.4));
            }
            this.collection.each(function(record, i) {
                if (record.get("lat") && record.get("lng")) {
                    ...
                    var latLngForZoomA = new google.maps.LatLng(lat + .005, lng + .005);
                    var latLngForZoomB = new google.maps.LatLng(lat - .005, lng - .005);
