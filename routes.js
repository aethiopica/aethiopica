...
exports = module.exports = function(app, passport) {
  ...
  //crud > places
  app.get('/crud/places/', require('./views/crud/places/index').find);
  app.post('/crud/places/', require('./views/crud/places/index').create);
  app.get('/crud/places/:id/', require('./views/crud/places/index').read);
